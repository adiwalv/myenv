...
func New() *Connect {
	...
	g := Connect{_getKey(), _getProfilePath(), service, "/var/run/pritunl.sock", map[string]profile{}}
	g.loadProfiles()
	return &g
}

func (g Connect) makeReq(verb string, endpoint string, data string) string {
...
func (g Connect) CheckStatus() string {
	s := g.makeReq("GET", "status", "")
	return gjson.Get(s, "status").String()
}

func (g Connect) Ping() bool {
...
func (g Connect) GetConnections() string {
	cons := g.makeReq("GET", "profile", "")
	return cons
}

func (g Connect) StopConnections() {
	g.makeReq("POST", "stop", "")
}

func (g Connect) loadProfiles() {
...
func (g Connect) GetProfile(id string) (string, string) {
	auth := ""
	key := ""
	g.loadProfiles()
	prof := g.Profiles[id]
...
func (g Connect) ConnectProfile(id string, user string, password string) {
...
func (g Connect) DisconnectProfile(id string) {
